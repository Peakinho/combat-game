let GameManager = {
   ...
   resetPlayer: function(classType) {
     switch (classType) {
       ...
       case "Luigi":
          ...
          break;
       case "Zelda":
          player = new Player(classType, 80, 0, 50, 200, 150)
          break;
       case "Tekkan":
     ...
     +'</p><p>Mana: '+ player.mana +'</p><p>Strength: '
     + player.strength +'</p><p>Agility: '
     + player.agility +'</p><p>Speed: '
     + player.speed +'</p></div>';
   ...
   setPreFight: function() {
     ...
     getHeader.innerHTML = '<p>Task: Find an ememy!</p>';
     getActions.innerHTML = '<a href="#" class="btn-prefight" onclick="GameManager.setFight()">Search for enemy!</a>';
     // getArena.style.visiblilty = "visable";
   },
   setFight: function() {
     let getHeader = document.querySelector(".header");
     let getActions = document.querySelector(".actions");
     ...
     // Create enemy!
     let enemy00 = new Enemy("Sonic", 100, 50, 50, 100, 100);
     let enemy01 = new Enemy("Spiro", 100, 50, 150, 100, 50);
